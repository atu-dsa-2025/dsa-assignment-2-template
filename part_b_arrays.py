...
if __name__ == "__main__":
    ...
    print("  search for 9  ->", binary_search(catalogue, 9))
    print("  search for 5  ->", binary_search(catalogue, 5))

    print("\nB2: find_pair_with_sum (target = 13)")
    print("  result ->", find_pair_with_sum(catalogue, 13))
    # e.g. 1 + 12 = 13 or 4 + 9 = 13 depending on pointer path

    print("\nB3: rotate_array")
    sample = [1, 2, 3, 4, 5]
    print("  rotate [1,2,3,4,5] by 2 ->", rotate_array(sample, 2))
